...
function Features() {
  ...
  return (
    <section className="h-full bg-slate-900 relative overflow-hidden common-padding ">
      <div className="screen-max-width">
        ...
        <div className="flex justify-center items-center overflow-hidden flex-col">
          <div className="mb-24 pl-24 mt-32">
            <h2 className="text-5xl lg:text-7xl font-semibold">Iphone</h2>{" "}
            <h2 className="text-5xl lg:text-7xl font-semibold">
              Forged in titanium.
            </h2>
          </div>
          <div className="flex-col sm:px-10 flex-center">
